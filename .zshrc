export ZSH_CUSTOM="$HOME/zsh_configs/.oh-my-zsh/custom"
...
export ZSH="$HOME/zsh_configs/.oh-my-zsh"
...
[[ ! -f $HOME/zsh_configs/.p10k.zsh ]] || source $HOME/zsh_configs/.p10k.zsh
...
abbr -S ed='emacs --daemon' >>/dev/null
...
abbr -S gdf='git diff' >>/dev/null
abbr -S gl='git log' >>/dev/null
abbr -S ggr='git grep' >>/dev/null
abbr -S gul='git pull' >>/dev/null
abbr -S gsw='git switch' >>/dev/null
abbr -S gush='git push' >>/dev/null
